    ...
    <div className="lg:hidden pb-4">
      <div className="px-2 pt-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-border/60 bg-surface-elevated/60 px-2 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-surface-elevated"
        >
      ...
      {paidThisMonth.length > 0 ? (
        <section>
          <h3 className="flex items-center justify-between px-2 pb-2 pt-4 text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
            <span>Este mês</span>
