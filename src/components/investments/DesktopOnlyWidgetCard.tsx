...
export function DesktopOnlyWidgetCard({
  ...
  return (
    <div
      ...
      className="lg:hidden mx-2 my-2 flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border/60 bg-surface-elevated/40 px-4 py-6 text-center"
    >
