        ...
        <div className="lg:hidden">
          ...
          {selectedGoal ? (
            <button
              type="button"
              onClick={() => navigate('/metas?tab=investments')}
              className="mx-2 mt-3 flex w-[calc(100%-1rem)] items-center gap-2 rounded-xl border border-primary/30 bg-primary/8 px-3 py-2.5 text-left transition-colors hover:bg-primary/12"
            >
