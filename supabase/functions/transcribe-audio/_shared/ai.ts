...
import { buildOpenAIChatBody, buildOpenAIResponsesBody, buildOpenRouterChatBody, extractOpenAICompatibleText, extractOpenAIResponsesText, usesOpenAIResponsesAPI } from '../../_shared/ai-openai-compatible.ts';
