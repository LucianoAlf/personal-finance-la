...
-- Alerta de contas vencidas (overdue)
ALTER TABLE notification_preferences
...
-- Migrar weekly_summary_day_of_week → weekly_summary_days_of_week
...
-- Migrar monthly_summary_day_of_month → monthly_summary_days_of_month
UPDATE notification_preferences
...
-- Migrar bill_reminders_days_before → bill_reminders_days_before_array
UPDATE notification_preferences
...
-- Migrar budget_alert_threshold_percentage → budget_alert_thresholds
UPDATE notification_preferences
...
-- Validar percentuais de metas (0-100)
ALTER TABLE notification_preferences
...
-- Atualizar timestamp de updated_at em todos os registros
UPDATE notification_preferences
SET updated_at = NOW()
