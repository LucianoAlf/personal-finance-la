-- Corrigir a view para pegar a fatura do mês atual ou mais recente
-- Prioridade: fatura do mês atual > fatura mais recente aberta
...
SELECT 
  ...
  cc.is_archived,
  cc.created_at,
  -- Fatura atual: a fatura aberta/partial do mês atual ou a mais recente
...
-- Fatura atual: pegar a fatura aberta/partial mais recente (maior reference_month)
LEFT JOIN LATERAL (
